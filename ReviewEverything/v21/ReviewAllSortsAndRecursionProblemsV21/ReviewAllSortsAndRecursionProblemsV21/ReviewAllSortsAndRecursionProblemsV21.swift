//
//  ReviewAllSortsAndRecursionProblemsV21.swift
//  ReviewAllSortsAndRecursionProblemsV21
//
...
func get_words_from_phone_number(phone_number: String) -> [String] {
  ...
  func helper(build: inout String, index: Int) {
    ...
    let character = phone_number[stringindex]
    if let letterArray = map[character] {
...
func find_all_arrangements(n: Int) -> [[String]] {
  ...
  func helper(build: inout [Int], index: Int) {
    if index > 1 {
      ...
      for earlierRow in 0..<build.count - 1 {
