//
//  ReviewAllSortsAndRecursionProblemsV10.swift
//  ReviewAllSortsAndRecursionProblemsV10
//
...
func quickSortLomuto(numbers: inout [Int]) {
  func helper(start: Int, end: Int) {
    ...
    let randomPivotIndx = Int.random(in: start...end)
    numbers.swapAt(randomPivotIndx, start)
  ...
  for i in 0..<balls.count {
    switch balls[i] {
      case "R":
        ...
        balls.swapAt(greenThreshold, blueThreshold)
        blueThreshold += 1
        greenThreshold += 1
