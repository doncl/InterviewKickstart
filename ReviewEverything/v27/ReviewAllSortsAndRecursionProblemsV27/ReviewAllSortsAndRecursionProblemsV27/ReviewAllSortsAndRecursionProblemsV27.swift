//
//  ReviewAllSortsAndRecursionProblemsV27.swift
//  ReviewAllSortsAndRecursionProblemsV27
//
...
func mergeSort(numbers: inout [Int]) {
  func helper(start: Int, end: Int) {
    ...
    while leftIdx <= midpoint && rightIdx <= end {
      let l = numbers[leftIdx]
      let r = numbers[rightIdx]
      if l <= r {
        aux.append(l)
        leftIdx += 1
      } else {
