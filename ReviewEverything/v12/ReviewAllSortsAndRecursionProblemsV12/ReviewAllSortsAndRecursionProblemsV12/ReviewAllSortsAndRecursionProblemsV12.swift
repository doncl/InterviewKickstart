//
//  ReviewAllSortsAndRecursionProblemsV12.swift
//  ReviewAllSortsAndRecursionProblemsV12
//
...
func generate_all_combinations(arr: [Int], target: Int) -> [[Int]] {
  ...
  var build: [Int] = []
  let sum = bank.reduce(0, +)
  helper(build: &build, index: 0, remaining: sum, target: target)
