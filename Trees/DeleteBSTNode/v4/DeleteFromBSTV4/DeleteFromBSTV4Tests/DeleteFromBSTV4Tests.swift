//
//  DeleteFromBSTV4Tests.swift
//  DeleteFromBSTV4Tests
//
//  Created by Don Clore on 4/11/23.
//

import XCTest
@testable import DeleteFromBSTV4

final class DeleteFromBSTV4Tests: XCTestCase {
  ...
  func testExample1() {
    ...
    func testCase2() {
      ...
      guard let root = delete_from_bst(root: ten, values_to_be_deleted: valuesToBeDelete) else {
        XCTFail("Unexpected nil return value")
        return
      }
