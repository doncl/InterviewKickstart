//
//  ReviewAllSortsV3Tests.swift
//  ReviewAllSortsV3Tests
//
//  Created by Don Clore on 2/10/23.
//

import XCTest
@testable import ReviewAllSortsV3

final class ReviewAllSortsTestsV3: XCTestCase {
  let numbersSmall = [2, 3, 1]
  ...
  lazy var numbers: [[Int]] = [numbersSmall]
